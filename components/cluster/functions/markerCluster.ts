import type MarkerCluster from "~/components/cluster/types/index";
...
import { LMarkerCluster } from "."

export const markerClusterProps = {
  ...componentProps,
  pane: {
    type: String,
  },
...
export const setupMarkerCluster = <T extends MarkerCluster >(
  props,
  leafletRef: Ref<T>,
  context
) => {
